...
int main(int argc, char **argv)
{
    ...
    if (strcmp(argv[1], "gpu") == 0)
    {
        ...
        output_image = gal_conv_gpu(input_image, kernel_image, "conv.cl", "convolution", "conv_core.h", input_image->size, 128, 1);
    ...
    else if (strcmp(argv[1], "cpu") == 0)
    {
        ...
        output_image = gal_conv_gpu(input_image, kernel_image, "conv.cl", "convolution", "conv_core.h", input_image->size, 128, 2);
